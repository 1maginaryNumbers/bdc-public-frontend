...
const Home = () => {
  ...
  const fetchGalleryImages = async () => {
    try {
      const response = await fetch('http://localhost:5000/api/galeri?limit=50');
      const data = await response.json();
  ...
  return (
    <div>
      <section 
        ...
        style={{
          backgroundImage: `url('http://localhost:5000/uploads/galeri/images-1760896504757-356016500.jpg')`
        }}
      >
